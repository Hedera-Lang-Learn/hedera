...
urlpatterns = [
    ...
    path("api/v1/lemmatization/partial_match_lemmas/<str:lang>/<str:lemma>/", api.PartialMatchLemmaLookupAPI.as_view()),
    ...
    path("api/v1/folder/", api.VocabFoldersAPI.as_view()),
    path("api/v1/folder/<int:pk>/", api.FoldersDetailAPI.as_view()),
