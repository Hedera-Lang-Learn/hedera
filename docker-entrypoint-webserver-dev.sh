...
export EMAIL_BACKEND=`aws ssm get-parameter --name /hedera/defaults/email_backend --output text --query Parameter.Value --region us-east-1`
export EMAIL_HOST=`aws ssm get-parameter --name /hedera/defaults/email_host --output text --query Parameter.Value --region us-east-1`
export EMAIL_PORT=`aws ssm get-parameter --name /hedera/defaults/email_port --output text --query Parameter.Value --region us-east-1`
export EMAIL_HOST_USER=`aws ssm get-parameter --name /hedera/defaults/email_host_user --output text --query Parameter.Value --region us-east-1`
export EMAIL_HOST_PASSWORD=`aws ssm get-parameter --name /hedera/defaults/email_host_password --with-decryption --output text --query Parameter.Value --region us-east-1`
export DEFAULT_FROM_EMAIL=`aws ssm get-parameter --name /hedera/defaults/default_from_email --output text --query Parameter.Value --region us-east-1`
export SENTRY_DSN=`aws ssm get-parameter --name /hedera/defaults/sentry_dsn --output text --query Parameter.Value --region us-east-1`
export SENTRY_ENVIRONMENT=dev
export EMAIL_USE_TLS=True
export USE_S3=True
export SITE_ID=2
export REDIS_URL=`aws ssm get-parameter --name /hedera/dev/redis_url --output text --query Parameter.Value --region us-east-1`
export RQ_ASYNC=1
