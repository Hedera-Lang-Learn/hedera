<template>
  <div class="app-container" :class="{ 'read-mode': readMode }">
    <div class="row">
      <div class="col-8">
        <LemmatizedText :vocab-entries="personalVocabList && personalVocabList.entries"
          :show-familiarity="showFamiliarity" @setRating="onSetRating" />
      </div>
      <div class="col-4">
        ...
        <div>
          <div class="nav nav-tabs mb-3">
            <li class="nav-item">
              <a href class="nav-link" :class="{ active: !readMode }" @click.prevent="readMode = false">Familiarity</a>
            </li>
            <li class="nav-item">
              <a href class="nav-link" :class="{ active: readMode }" @click.prevent="readMode = true">Glosses</a>
            </li>
          </div>
        </div>
        <div class="glosses" v-if="readMode">
          ...
          <div class="glossed-token" :class="{
    selected: selectedToken && selectedToken.node,
  }" v-for="token in glosses" :key="token.pk">
