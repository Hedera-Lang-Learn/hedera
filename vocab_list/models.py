...
#     vocab_list_id = models.ManyToManyField(VocabularyList, blank=True)
#     personal_vocab_list_id = models.ManyToManyField(PersonalVocabularyList, blank=True)
...
#             vocabListId=self.vocab_list_id,
#             personalVocabList=self.personal_vocab_list_id
#         )

#     class Meta:
#         verbose_name = "folder to vocabulary list link"
