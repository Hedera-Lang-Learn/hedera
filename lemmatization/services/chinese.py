...
class ChineseTokenizer(Tokenizer):
    ...
    def tokenize(self, text: str) -> TripleIterable:
        ...
        unicode_normalized_text = normalize_chinese(text)
        ...
        lemma_triples = get_triples(tokens)
...
def get_triples(tokens: Iterable[str]) -> TripleIterable:
    """
    ...
    for token in tokens:
        ...
        if CHINESE_RE.match(token):
            ...
            if current_token or following:
                ...
                yield (current_token, normalize_token(current_token), following)
